...
<div class="grid grid-cols-2 gap-6 mt-8">
  ...
  <div v-click class="glass rounded-xl overflow-hidden" style="border-color: rgba(0,229,255,0.2);">
    ...
    <div style="padding: 16px 20px; display: flex; flex-direction: column; gap: 10px;">
      <div class="flex items-start gap-3" style="font-size: 15px; line-height: 1.5;">
        ...
        Vibe coding is fast — but it leaves loose ends and hidden assumptions
      </div>
      <div class="flex items-start gap-3" style="font-size: 15px; line-height: 1.5;">
        <span style="color: rgba(0,229,255,0.6); flex-shrink: 0; font-size: 18px; margin-top: 1px;">·</span>
  ...
  <!-- Card 2: Don't Stop Learning -->
  <div v-click class="glass rounded-xl overflow-hidden" style="border-color: rgba(124,92,255,0.2);">
    <div style="background: rgba(124,92,255,0.08); padding: 12px 20px; display: flex; align-items: center; gap: 10px; border-bottom: 1px solid rgba(124,92,255,0.15);">
      <div class="i-carbon:book" style="font-size: 22px; color: #7c5cff;" />
      <span style="font-size: 17px; font-weight: 600; color: #7c5cff;">Learn from AI</span>
    </div>
    <div style="padding: 16px 20px; display: flex; flex-direction: column; gap: 10px;">
      <div class="flex items-start gap-3" style="font-size: 15px; line-height: 1.5;">
