...
<div style="margin-top: 28px; display: flex; flex-direction: column; gap: 32px;">
  ...
  <div :class="[$clicks >= 4 ? 'opacity-100' : 'opacity-0']" class="transition duration-500 neon-hr" style="max-width: 860px;"></div>
  <div>
    <div :class="[$clicks >= 4 ? 'opacity-100' : 'opacity-0']" class="transition duration-400"
    ...
    <div style="display: flex; align-items: center; gap: 8px; flex-wrap: wrap; font-size: 14px;">
      ...
      <div :class="[$clicks >= 5 ? 'opacity-100 scale-100' : 'opacity-0 scale-95']"
        ...
        <span style="color: rgba(255,255,255,0.5); font-size: 11px; display: block; margin-bottom: 2px;">write</span>
        Document
        <span style="font-size: 11px; color: rgba(255,255,255,0.4); display: block;">(what + how to test)</span>
      </div>
...
<div :class="[$clicks >= 7 ? 'opacity-100' : 'opacity-0']" class="transition duration-500 delay-300 mt-6 glass rounded-lg px-5 py-3"
